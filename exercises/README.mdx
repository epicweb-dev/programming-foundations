...
<EpicVideo url="https://www.epicweb.dev/tutorials/programming-foundations/introduction-to-programming-foundations/intro-to-introduction-to-programming-foundations" />
...
<callout-info>
	**Semicolons and ASI**: JavaScript has *Automatic Semicolon Insertion (ASI)*,
	...
	in JavaScript: A
	preference](https://kentcdodds.com/blog/semicolons-in-javascript-a-preference).
</callout-info>
