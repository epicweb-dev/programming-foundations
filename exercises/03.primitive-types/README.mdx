...
<EpicVideo url="https://www.epicweb.dev/tutorials/programming-foundations/3-primitive-types/intro-to-primitive-types" />
...
You'll also see how booleans can come from **truthy** and **falsy** values—an
everyday JavaScript pattern for checking whether a value "exists."
